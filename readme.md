...
結合檢索強化的優點，可以在向量資料庫中搜尋近似的歷史樣本，提供模型更多的線索去判斷。並且當有新形態的樣本出現時，可以新增至向量資料庫中獲得部分的知識而非只能從頭訓練。
# 注意
...
## 檢索筆數分析
透過Top-K筆的鄰居樣本進行實驗，比較K在1~5的情況下，何者可以取得較高的F1成績。由圖中可以看到當K由1提高至3時，模型數據穩步上升到最高點。但當K=4與5時，明顯出現崩潰情況，說明過多的鄰居資訊開始阻礙模型判斷。
